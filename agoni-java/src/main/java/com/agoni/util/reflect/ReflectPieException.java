 ...
 * @author Lukas Eder
 */
public class ReflectPieException extends RuntimeException {
    ...
    public ReflectPieException(String message) {
        super(message);
    }

    public ReflectPieException(String message, Throwable cause) {
        super(message, cause);
    }

    public ReflectPieException() {
        super();
    }

    public ReflectPieException(Throwable cause) {
        super(cause);
    }
}
